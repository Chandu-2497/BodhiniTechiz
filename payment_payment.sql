...
CREATE TABLE `payment` (
  ...
  `totalAmountToMentor` float DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `payment` VALUES (1,'Testing txntype1',200,'test remarks1',1,'Chandrika',1,'SpringBoot',200),(3,'Testing txntype2',200,'test remarks2',1,'Chandrika',1,'SpringBoot',200);
